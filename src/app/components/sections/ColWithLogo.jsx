...
const ColWithLogo = () => {
    return (
        <section className='w-full relative py-[100px] overflow-hidden max-w-[1920px]  mx-auto min-h-[632px] flex flex-col justify-center bg-[#f8f9fa] px-0 py-[150px]' >
            <div className="container">
                <h2 className='font-semibold leading-[1.1] tracking-normal max-w-[960px] text-[#151831] text-[50px] font-[Proxima-Nova]'>Certified for high-compliance government and commercial environments</h2>
                <div className='flex justify-center items-center  flex-wrap mt-[30px]'>
                    <div className="basis-3/12  mx-auto mt-[10px] relative">
                        <div className='mx-auto max-w-[281px] h-[130px] w-full mx-auto'>
                            <Image
