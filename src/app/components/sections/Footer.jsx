    ...
    return (
        <footer className='bg-[#151831] max-w-[1920px] mx-auto w-full relative'>
            <div className="container">
                <div className='pt-[80px] pr-0 pb-[47px] pl-0 flex items-start flex-wrap'>
                    <div className='basis-2/12 flex justify-center flex-col w-1/2 float-left relative'>
                        ...
                        <div className="mt-[41px]">
                            ...
                            <div className="mt-[16px]">
                                ...
                                <a aria-label="social-media-links" className="max-w-[20px] h-[16px] cursor-pointer inline-block mr-[11px] relative text-white" href="https://www.linkedin.com/company/authentic8" rel="noopener noreferrer" target="_blank">
                                    <svg fill="#ffffff" viewBox="0 0 15.926 19" className='w-full h-full'> <defs> <clipPath className="clip-path"> <path className="cls-1" d="M0 0H15.926V19H0z" id="Rectangle_73"></path> </clipPath> </defs> <g id="Group_112"> <g clip-path="url(#clip-path)" id="Group_111"> <path className="cls-1" d="M.569 4.455A1.846 1.846 0 0 1 0 3.1a1.846 1.846 0 0 1 .569-1.348 1.846 1.846 0 0 1 1.351-.569 1.845 1.845 0 0 1 1.35.569A1.846 1.846 0 0 1 3.839 3.1a1.846 1.846 0 0 1-.569 1.355 1.845 1.845 0 0 1-1.35.569 1.846 1.846 0 0 1-1.351-.569zm-.32 12.654V6.481h3.306v10.628zm12.37 0V11.92a5.781 5.781 0 0 0-.212-1.849 1.5 1.5 0 0 0-1.529-.96 1.666 1.666 0 0 0-1.6.854 3.971 3.971 0 0 0-.355 1.884v5.26h-3.27V6.481h3.164v1.457h.035a2.833 2.833 0 0 1 1.137-1.173 3.5 3.5 0 0 1 1.99-.569 3.526 3.526 0 0 1 3.235 1.458 7.185 7.185 0 0 1 .711 3.626v5.829z" id="Path_19" transform="translate(0 .611)"></path> </g> </g> </svg>
                                </a>
                    ...
                    <div className="basis-10/12 flex">
                        <div className="mr-[20px] mt-[30px] pl-[39px]">
                            <ul>
                                <li>
